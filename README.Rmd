...
It seems duckdb, duckplyr and dplyr (with duckdb or tidypolars streaming backends) are the fastest options for 1e9 rows.
...
If you what, look at other languages solutions (run.php for PHP or onebrc for rust)
